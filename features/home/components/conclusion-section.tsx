      ...
      <div className="container grid items-center gap-12 md:grid-cols-2">
        <div>
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            ...
            thiện chí ngoại giao, mà bởi thực dân Pháp không muốn có một nền hòa
            bình dựa trên sự tôn trọng chủ quyền.
          </p>
          <p className="mt-5 text-lg leading-8 text-muted-foreground">
            Nếu Việt Nam nhượng bộ thêm trước tối hậu thư, điều nhận được không
            phải là hòa bình mà là sự tự sát dân tộc, mất quyền tự quyết và để
            bộ máy chính quyền bị xóa bỏ. Vì vậy, cuộc chiến bảo vệ Tổ quốc là
        ...
        <div className="relative">
          <div className="relative aspect-video overflow-hidden rounded-2xl shadow-2xl">
            <Image
              ...
              src="https://res.cloudinary.com/dratbz8bh/image/upload/v1782283742/khang-chien2_fhnpnk.jpg"
            />
